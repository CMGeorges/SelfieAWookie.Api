...
namespace SelfieAWookie.Core.Selfies.Infrastructures.Loggers
{
    public class CustomLoggerProvider : ILoggerProvider
    {
        ...
        #region Fields
        private ConcurrentDictionary<string,CustomMessageLogger> _loggers = new  ConcurrentDictionary<string, CustomMessageLogger>();//Making sure there's only unique logger.
        #endregion
